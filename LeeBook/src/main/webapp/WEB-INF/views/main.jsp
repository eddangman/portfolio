			...
			<div class="content_area">			
				<div class="slide_div_wrap">
					<div class="slide_div">
						<div>
							<a>
								<img src="../resources/img/bnA_w01_a8daff.jpg" style="width: 100%; height: 100%;">
							</a>
						</div>
						<div>
							<a>
								<img src="../resources/img/bnD_w01_c3c5f7.jpg" style="width: 100%; height: 100%;">
							</a>
						</div>
						<div>
							<a>
								<img src="../resources/img/bnK_w01_c3c5f7.jpg" style="width: 100%; height: 100%;" >
							</a>
						</div>				
					</div>	
				</div>				
			...
			<div class="footer">
				<div class="footer_container">		
					...
					<div class="footer_right">
						...
						<br>
						<br>
						COPYRIGHT(C) <strong>eddangman.tistory.com</strong>	ALL RIGHTS RESERVED.
					</div>
					<div class="clearfix"></div>
				</div>
			</div> <!-- class="footer" -->					
